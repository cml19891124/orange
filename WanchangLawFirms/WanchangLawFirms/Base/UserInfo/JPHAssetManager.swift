...
class JPHAssetManager: NSObject {
    static let share = JPHAssetManager()
    
    private var h_me_consult: [PHAsset] = [PHAsset]()
    private var h_agreement_custom: [PHAsset] = [PHAsset]()
    private var h_agreement_check: [PHAsset] = [PHAsset]()
    private var h_lawyer_letter: [PHAsset] = [PHAsset]()
    private var h_notification_letter: [PHAsset] = [PHAsset]()
    private var h_litigant_document: [PHAsset] = [PHAsset]()
    private var h_business_business_contract: [PHAsset] = [PHAsset]()
    private var h_business_equity_affairs: [PHAsset] = [PHAsset]()
    private var h_business_manage_system: [PHAsset] = [PHAsset]()
    private var h_business_litigant_document: [PHAsset] = [PHAsset]()
    private var h_business_lawyer_letter: [PHAsset] = [PHAsset]()
    private var h_business_book_check: [PHAsset] = [PHAsset]()
    private var h_business_consult: [PHAsset] = [PHAsset]()
    
    func save(id: String, assets: [PHAsset]) {
        if id == "h_me_consult" {
            h_me_consult = assets
