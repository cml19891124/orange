//
//  MineBusinessFeedbackController.swift
//  WanchangLawFirms
//
...
class MineBusinessFeedbackController: BaseController {
    ...
    private lazy var tabView: UITableView = {
        ...
        temp.register(MineBusinessFeedbackTypeCell.self, forCellReuseIdentifier: "MineBusinessFeedbackTypeCell")
...
extension MineBusinessFeedbackController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if bind == "type" {
            let cell = tableView.dequeueReusableCell(withIdentifier: "MineBusinessFeedbackTypeCell", for: indexPath) as! MineBusinessFeedbackTypeCell
            cell.delegate = self
            return cell
...
extension MineBusinessFeedbackController: MineFeedbackTypeCellDelegate {
    func mineFeedbackTypeCellClick(type: String) {
        self.type = type
    }
}

extension MineBusinessFeedbackController: JPhotoCenterDelegate {
...
extension MineBusinessFeedbackController: UITextViewDelegate {
...
extension MineBusinessFeedbackController: UITextFieldDelegate {
...
extension MineBusinessFeedbackController: JOKBtnCellDelegate {
