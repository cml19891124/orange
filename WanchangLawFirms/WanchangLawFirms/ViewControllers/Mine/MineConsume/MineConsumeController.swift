...
/// 消费记录
class MineConsumeController: BaseController {
    ...
    private lazy var listView: JTabNotiView = {
        ...
        tabView.register(MineConsumeCell.self, forCellReuseIdentifier: "MineConsumeCell")
...
extension MineConsumeController: JTabNotiViewDataSource {
...
extension MineConsumeController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "MineConsumeCell", for: indexPath) as! MineConsumeCell
        cell.model = model
        return cell
    }
