...
//    private let contentLab: UILabel = UILabel.init(kFontMS, UIColor.white, NSTextAlignment.left)
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        _ = contentLab.sd_layout()?.rightSpaceToView(bubbleImgView, kBubbleSpaceL)?.topSpaceToView(bubbleImgView, kBubbleSpaceS)?.leftSpaceToView(bubbleImgView, kBubbleSpaceS)?.bottomSpaceToView(bubbleImgView, kBubbleSpaceS)
    }
